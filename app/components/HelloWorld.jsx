...
function PageRoot() {
  ...
  return (
    <div>
      ...
      <button style={buttonStyle} onClick={() => playGame(0)}>
        {" "}
        {grid[0][0]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(1)}>
        {" "}
        {grid[0][1]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(2)}>
        {" "}
        {grid[0][2]}{" "}
      </button>
      <br></br>
      <button style={buttonStyle} onClick={() => playGame(3)}>
        {" "}
        {grid[1][0]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(4)}>
        {" "}
        {grid[1][1]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(5)}>
        {" "}
        {grid[1][2]}{" "}
      </button>
      <br></br>
      <button style={buttonStyle} onClick={() => playGame(6)}>
        {" "}
        {grid[2][0]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(7)}>
        {" "}
        {grid[2][1]}{" "}
      </button>
      <button style={buttonStyle} onClick={() => playGame(8)}>
        {" "}
        {grid[2][2]}{" "}
      </button>
      <br></br>
